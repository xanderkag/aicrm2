    ...
    <div className="min-h-screen bg-[#050505] flex items-center justify-center p-6 chat-pattern relative overflow-hidden">
      ...
      >
        ...
        <div className="flex flex-col items-center mb-10">
          ...
          <p className="text-[14px] font-medium text-white/30 uppercase tracking-[0.3em]">Access Management</p>
        </div>
        ...
        <div className="glass-card p-8 rounded-[32px] border border-white/5 bg-secondary/40 backdrop-blur-3xl shadow-2xl relative">
          ...
          <div className="relative z-10 space-y-8">
            <div className="space-y-2">
              <h2 className="text-[18px] font-bold text-white">System Identification</h2>
              <p className="text-[14px] text-white/50 leading-relaxed">
                Please authenticate using your authorized workspace account.
              </p>
            </div>
            ...
            <div className="pt-4 flex items-center justify-center gap-4 text-[12px] font-black uppercase tracking-widest text-white/20">
        ...
        <motion.p 
          ...
          className="mt-8 text-center text-[12px] text-white/20 font-medium"
        >
          Protected by Antigravity CRM Infrastructure
        </motion.p>
      </motion.div>
    </div>
  );
